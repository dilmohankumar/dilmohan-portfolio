...
export default function ExperienceSection({ section, experience, dark, accent, muted, card }) {
    ...
    <section className={`py-20 border-t ${dark ? "border-[#1a1a1a]" : "border-[#e8e4dc]"}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-6 mt-10">
          {experience.map((e) => (
            <div key={e._id} className={`${card} border rounded-2xl p-6 hover:border-[#00c896] transition-colors group`}>
